...
class AuthController extends GetxController {
  ...
  String get userRole {
    // 1. Prioritize the role from the active context switcher
    if (activeContext.value != null && activeContext.value!.role.isNotEmpty) {
      return activeContext.value!.role.toLowerCase();
    }

    // 2. Fallback to the primary role assigned at login
    final userData = user; // Assuming 'user' is your Map<String, dynamic> or RxMap
    if (userData.isNotEmpty && userData['role'] != null) {
