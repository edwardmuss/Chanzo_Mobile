...
class _ConfirmSwitchAndGoState extends State<ConfirmSwitchAndGo> {
  ...
  Future<void> _continue() async {
    ...
    try {
      ...
      // Check widget.role instead of auth.userRole
      // to guarantee we evaluate the role they are actively switching to.
      if (widget.role == 'parent' && auth.allStudents.isNotEmpty) {
