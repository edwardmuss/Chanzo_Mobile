...
import 'package:chanzo/pages/assessment/formative/formative_dashboard_screen.dart';
import 'package:chanzo/pages/assessment/reports/class_exam_performance_screen.dart';
import 'package:chanzo/pages/assessment/reports/class_stream_performance_screen.dart';
import 'package:chanzo/pages/assessment/reports/subject_performance_screen.dart';
import 'package:chanzo/pages/homework/teacher_homework_screen.dart';
import 'package:chanzo/pages/students/student_list_screen.dart';
import 'package:chanzo/pages/teachers/scheme_of_work/scheme_of_work_screen.dart';
import 'package:chanzo/pages/subjects/teacher_classes_subjects_screen.dart';
...
import 'package:chanzo/pages/Examination/parent_results_home_screen.dart';
import 'package:chanzo/pages/calendar/calendar_screen.dart';
import 'package:chanzo/pages/homework/homework_screen.dart';
import 'package:chanzo/pages/kiota_categories/list.dart';
import 'package:chanzo/globalclass/text_icon_button.dart';
import 'package:chanzo/pages/dahsboard/dahsboard.dart';
import 'package:chanzo/pages/settings/settings.dart';
              ...
              onPressed: () async {
                await openContextSwitcher(
                  ...
                  onContextChanged: () async {
                    ...
                    // FIX: Safely check if the controller exists before calling it
                  ...
                  onStudentChanged: () async {
                    ...
                    // Safely check if the controller exists before calling it
                    if (Get.isRegistered<PerformanceController>()) {
                      await Get.find<PerformanceController>().refreshData();
                    }
                  },
                );
                // NOTE: Removed Navigator.pop() from here. Your openContextSwitcher
                // already handles popping the bottom sheet internally on success.
