...
class _ChatSidebarState extends State<ChatSidebar> {
  ...
  Future<void> fetchSessions({bool initial = false}) async {
    ...
    final baseUrl = KiotaPayConstants.fetchSessions;
  ...
  Future<void> renameSession(ChatSession session) async {
    ...
    if (newTitle != null && newTitle.isNotEmpty && newTitle != session.title) {
      final url = Uri.parse('${KiotaPayConstants.baseUrl}chat/sessions/${session.id}');
...
class ChatSession {
  ...
  factory ChatSession.fromJson(Map<String, dynamic> json) {
    final parsedValue = json['value'];

    return ChatSession(
      id: parsedValue['thread_id'].toString(),
