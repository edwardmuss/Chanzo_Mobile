...
import 'package:chanzo/pages/home/home.dart';
import 'package:chanzo/pages/settings/settings.dart';
import 'package:chanzo/pages/kiotapay_statistics/kiotapay_statistics.dart';
import 'package:chanzo/pages/payroll/payroll_screen.dart';
...
import '../authentication/change_password_new_user.dart';
    ...
    return BottomAppBar(
      ...
      child: Row(
        ...
        children: [
          ...
          ItemBottomBar(
            icon: isTeacher ? BootstrapIcons.receipt_cutoff : BootstrapIcons.bar_chart_line,
            selected: _selectedItemIndex == 1,
            label: isTeacher ? "Payslip" : "Finance", // Dynamic Label
            onPressed: () => _onTap(1),
          ),
          ...
          ItemBottomBar(
            ...
            label: isTeacher ? "My Timetable" : "Academics", // Dynamic Label
            onPressed: () => _onTap(2),
          ),
          ItemBottomBar(
